...
// Creatures and characters carry battle stats (bs: [atk, hp] on a shared
// 1-100 scale): the trio's are normalized from their real printed stats,
// every other game's characters get tier-derived power. Events, items,
// sites and other non-character cards are collection-only.
export const TEAM_SIZE = 3;

const fighters = cards.filter((c) => Array.isArray(c.bs));
// deck-legal cards: creatures and characters only
const deckable = cards.filter((c) => Array.isArray(c.bs));
